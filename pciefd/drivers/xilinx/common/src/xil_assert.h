...
#define Xil_AssertNonvoid(Expression) ({            \
    if (WARN_ON(!(Expression))) {                   \
        pr_debug("Xil_AssertNonvoid: %s %i %s\n",   \
            __func__, __LINE__, __FILE__);          \
        return 0;                                   \
    }                                               \
})
...
*
******************************************************************************/
#define Xil_AssertVoidAlways() Xil_AssertVoid(1)
...
*
******************************************************************************/
#define Xil_AssertNonvoidAlways() Xil_AssertNonvoid(1)
